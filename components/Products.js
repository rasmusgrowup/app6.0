    ...
    <>
      <section className={css.webSection}>
        <div className={css.upper}>
          ...
          <p className={css.upperText}>Vores ydelser er skræddersyet til start-ups og etablerede virksomheder, og er centreret omkring branding, visuel kommunikation og web-udvikling. Vi er specialister i at udtænke og levere skræddersyet indhold til hjemmesider, netbutikker og sociale medier, arbejde med visuelt design til branding af produkter og virksomheder, søgemaskineoptimering og webudvikling i React og Shopify.</p>
          <p className={css.upperText}>Vi forsøger med andre ord at tilbyde en suite af ydelser, der kan løse jeres digitale og kreative udfordringer, og hjælpe jer med at sælge flere varer.</p>
        </div>
